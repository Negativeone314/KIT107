...
//COMPLETE ME
			Object front = first.getData();
			return front;	//CHANGE ME
		}
...
//COMPLETE ME
		...
		{
			c = first;  // Start from the first node
			while (c.getNext() != null) {  // Traverse to the end of the queue
				c = c.getNext();
			}
			c.setNext(n);  // Add the new node at the end
		}
